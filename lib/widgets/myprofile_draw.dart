...
class _MyProfileState extends State<MyProfile> with TickerProviderStateMixin {
  ...
  ScrollController _scrollControllerPageBuilder;
  ...
  void initState() {
    ...
    _scrollControllerPageBuilder = ScrollController()
                  ...
                  child: (itemCount != null)
                      ? DefaultTabController(
                          ...
                          child: NestedScrollView(
                              controller: _scrollControllerPageBuilder,
                              ...
                              body:
                                ...
                                onNotification: (_) {
                                  ...
                                  print(_scrollControllerPageBuilder);
                                  if (_scrollController.offset >= 46) {}
      ...
      delegate: SliverChildListDelegate([
        Container(
          child: CustomTabView(
            ...
            itemCount: catalogoTabsBuilder.length,
            tabBuilder: (context, index) =>
                Tab(text: catalogoTabsBuilder[index].name),
            pageBuilder: (context, index) =>
                Center(child: Text(catalogoTabsBuilder[index].name)),
...
class CustomTab2View extends StatefulWidget {
  final int itemCount;
  final IndexedWidgetBuilder tabBuilder;
  final IndexedWidgetBuilder pageBuilder;
  final Widget stub;
  ...
  @override
  _CustomTabs2State createState() => _CustomTabs2State();
}

class _CustomTabs2State extends State<CustomTab2View>
    with TickerProviderStateMixin {
  TabController controller;
  int _currentCount;
  int _currentPosition;
  ...
  @override
  void didUpdateWidget(CustomTab2View oldWidget) {
    if (_currentCount != widget.itemCount) {
      controller.animation.removeListener(onScroll);
      controller.removeListener(onPositionChange);
      controller.dispose();
